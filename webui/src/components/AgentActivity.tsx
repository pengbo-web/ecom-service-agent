...
import { Brain, Wrench, ClipboardList, ShieldAlert, ChevronDown, ChevronRight, Route, GitBranch, CheckCircle2, Sparkles } from "lucide-react";
        ...
        <div className="flex flex-col gap-1 px-3 pb-2">
          {events.map((e, i) => (
            <div key={i} className="flex items-start gap-1.5">
              ...
              {e.type === "route" && <><Route className="mt-0.5 h-3.5 w-3.5 text-primary" /><span>路由 → <b>{ROUTE_LABEL[String(e.key)] ?? e.key}</b> Agent</span></>}
